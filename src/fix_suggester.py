...
class FixSuggester:
    ...
    async def suggest_fixes(
        self, audit_results: Dict, company_data: Dict
    ) -> List[Dict]:
    ...
    async def _suggest_fixes_with_gemini(
        self, violations: List[Dict], company_data: Dict
    ) -> List[Dict]:
    ...
    def _suggest_fixes_with_templates(
        self, violations: List[Dict], company_data: Dict
    ) -> List[Dict]:
