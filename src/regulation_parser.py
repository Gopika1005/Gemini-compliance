...
class RegulationParser:
    ...
    async def parse_regulation_from_text(self, regulation_text: str, regulation_name: str) -> Dict:
    ...
    async def _parse_with_gemini(self, regulation_text: str, regulation_name: str) -> Dict:
    ...
    def _parse_with_fallback(self, regulation_name: str) -> Dict:
        ...
        regulations = {
            "GDPR": {
                ...
                "applicable_systems": ["data_collection", "data_storage", "user_interface"],
                "penalties": {
        ...
        return regulations.get(regulation_name, self._get_default_regulation(regulation_name))
